                  ...
                  <div className="chat-messages p-4">
                    ...
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Developer</div>
                    ...
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Developer</div>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt a laborum voluptatum obcaecati rerum, cumque eius, eum nostrum ipsa nulla officiis dolores tempore.
                      </div>
                    </div>
                    <div className="chat-message-right mb-4">
                      <div>
                    ...
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Developer</div>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis in mollitia beatae nam? Nisi a optio eum, fuga eaque omnis quae ratione nulla?
                      </div>
                    </div>
                    <div className="chat-message-right mb-4">
                      <div>
                    ...
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Developer</div>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempore nemo libero vel quam, adipisci fuga ullam, quibusdam eum rerum quisquam blanditiis aut excepturi suscipit officiis praesentium consequuntur corrupti deleniti perferendis fugit? Quidem et, a deserunt laudantium ipsam odio mollitia ex officia tempora ipsa. Fuga a nostrum consectetur esse rem libero quod similique? Explicabo officia eos possimus! Sapiente, aperiam facere? Veritatis facilis laborum repellat reiciendis nulla doloremque excepturi perspiciatis quaerat officiis unde animi dicta ex architecto, ipsa dolore vitae.
                      </div>
                    </div>
                  </div>
                </div>
